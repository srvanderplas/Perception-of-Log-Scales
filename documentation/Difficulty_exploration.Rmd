...
*See https://emily-robinson.shinyapps.io/SimulationExplorationApp/ to look at other parameter combinations.*

# Exponential: Multiplicative

For $$y = \alpha(\beta x + \epsilon) + \theta$$ with $xRange = (0, 30), N = 20, \alpha = 1, \theta = 0,$ and $\epsilon ~N(0, sdErr)$ where $sdErr = 1%$ of $y$ range.

```{r ExpMultParms, cache = T, echo = F}
#Identify parameters
...
```{r ExpMultVisuals, cache = T, echo = F}
#Look at visuals
