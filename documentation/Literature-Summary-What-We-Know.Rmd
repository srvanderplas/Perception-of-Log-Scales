...
- sample size
  ...
  - for exponentials, more points decreases accuracy [@wagenaar1979pond] (@wagenaar_extrapolation_1978 is cited in @best2007perception, but they don't appear to manipulate n in that study, so???)
