...
3. Within low variability, it is is still pretty easy to pick out a target plot with medium curvature embeded in null plots of (easy curvature) lots of curvature, but maybe not as easy as in (2). It is more difficult to differentiate this within the high variability and we are maybe seeing a benefit here of displaying the data on the log scale.

4. Within low variability, it is difficult to select a target panel with hard curvature (close to a straight line) within null panels with ha
