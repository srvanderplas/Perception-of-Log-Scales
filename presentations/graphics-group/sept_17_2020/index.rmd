...
- Vist this [**REDDIT LINK**](https://old.reddit.com/r/datavis_testing/comments/itd4hs/visual_inference_graphics_group_20200917/?) and follow the instructions for the experimental task.
...
.center[
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/heuristic-simulation-yes-theta.png", alt = " ", other=list(width="45%"))
...
See [**simulation**](https://srvanderplas.github.io/Perception-of-Log-Scales/lineups-development/simulations/model-options.html) documentation for comparisons.
...
See [**parameter selection**](https://srvanderplas.github.io/Perception-of-Log-Scales/lineups-development/simulations/heuristic-difficulty-notheta.html) documentation for density plots of the lack of fit statistic at different parameter value combinations.
...
- 18 total parameter value combinations of interest

    - Target / Null panel combinations

- 2 scales (log/linear)

- Each individual recieves 12 lineups:

    - Randomly assigned 6 parameter value combinations
    
    - Independently assigned each parameter value combination a set on the linear and on the log scale.
    
???
- parameter values come from: E/M/Hi Curvature, Lv/Hv Variability, and Target/Null plots. We compare within variability and within curvature for each combination of target/null. 

    -For example, Target-E-Lv_Null-M-Lv is different from Target-M-Lv_Null-E-Lv.
    
- Is it harder to pick out a target with more curvature than the null than it is to pick out a target with less curvatuer than the null? or vise versa?
...
- See [**Previous Literature**](https://srvanderplas.github.io/Perception-of-Log-Scales/presentations/graphics-group/sept_17_2020/previous-literature.html)
