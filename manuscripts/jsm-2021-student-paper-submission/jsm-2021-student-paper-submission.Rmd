...
Statistical lineups provide an elegant way of combining perception and statistical signficiance by valdiating the findings from a graphical experiment \citep{buja_statistical_2009, wickham2010graphical, majumder_validation_2013}.
...
The heuristic data generation procedure is provided in \ref{app:generation}.
}
...
Each plot was evaluated between 18 and 28 individuals (Mean: 21.77, SD: 2.29). In 67% of the 477 lineup evaluations, participants correctly identified the target panel.
}
\er{
...
```{r odds-ratio-plot, eval = T, fig.width = 5, fig.height = 2, fig.align='center', fig.cap = "Odds Ratio's"}
slice_curvature <- read_csv("results/jsm-student-paper-slice-curvature.csv") %>% rename(Simple.Effect.Level = `Simple Effect Level`)
