...
Better software has meant easier and more flexible drawing, consistent themes, and higher standards.\textcolor{Green}{You need to source this somehow, please. Otherwise it seems disconnected from your main argument.}
Consequentially, we must develop a set of principles to help us actively choose which of many possible graphics to draw \citep{unwin_why_2020}.\textcolor{Green}{You might need to lead into this a bit more - connect the purposes we use these graphics for to the fact that different choices serve those purposes in different ways.}
}
...
Logarithms \textcolor{Green}{make} multiplicative relationships \textcolor{Green}{additive}, providing an elegant way to span many orders of magnitude, to show elasticities and other proportional changes, and to linearize power laws \citep{menge_logarithmic_2018}. 
...
\textcolor{Green}{This is the difference between a transformed scale transformed values; it's not the difference between untransformed values and transformed values. see https://r4ds.had.co.nz/graphics-for-communication.html\#scales for an explanation of scales, but I'm still looking for a perfect reference for transformations at the value vs. scale level.}
\textcolor{Orange}{We have recently experienced the benefits and pitfalls of using log-scales as covid-19 dashboards displayed case count data on both the log and linear scale \citep{wade_fagen_ulmschneider_2020}. 
...
\textcolor{Orange}{
Previous research suggests our perception and mapping of numbers to a number line proceeds logarithmically at first and transitions to linear later in development\textcolor{Green}{, after formal schooling begins}.
The logarithmic mapping is more noticeable in larger numbers as the transition to linear mapping occurs first for small numbers in young children and later for larger numbers \citep{varshney_why_2013, siegler_numerical_2017, dehaeneLogLinearDistinct2008}.\textcolor{Green}{Invert this sentence, because right now it's a bit confusing... e.g. In young children, the transition to linear scales occurs first in small numbers (e.g. 1-10) and then gradually expands to higher orders of magnitude; thus, the logarithmic intuition about numbers in children is often more noticeable on scales in the thousands to hundreds of thousands.}
